    ...
    <div class="breadcumb-wrapper" data-bg-src="{{ asset('assets/img/bg/breadcumb-bg.png') }}">
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Blog Standard Two</h1>
                <div class="breadcumb-menu-wrap">
                    <div class="breadcumb-menu">
                        <span><a href="{{ route('home') }}">Home</a></span>
                        <span>Blog Standard Two</span>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-12 wow animate__fadeInUp" data-wow-delay="0.25s">
                            <div class="vs-blog blog-style1">
                                ...
                                <div class="blog-content">
                                    ...
                                    <h2 class="blog-title">
                                        <a href="{{ route('blog-details') }}">Lorem ipsum dolor sit amet consect etur adipiscing elit</a>
                                    </h2>
                                    <div class="btn-area">
