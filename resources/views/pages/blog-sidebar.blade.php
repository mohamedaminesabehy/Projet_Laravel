    ...
    <div class="breadcumb-wrapper" data-bg-src="{{ asset('assets/img/bg/breadcumb-bg.png') }}">
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Blog Side Bar</h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-8 col-lg-7">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6 col-lg-12 col-md-6 wow animate__fadeInUp" data-wow-delay="0.25s">
                        ...
                        <div class="col-xl-6 col-lg-12 col-md-6 wow animate__fadeInUp" data-wow-delay="0.35s">
                            <div class="vs-blog blog-style1">
                                <div class="blog-img">
                        ...
                        <div class="col-xl-6 col-lg-12 col-md-6 wow animate__fadeInUp" data-wow-delay="0.45s">
                            <div class="vs-blog blog-style1">
                                <div class="blog-img">
                        ...
                        <div class="col-xl-6 col-lg-12 col-md-6 wow animate__fadeInUp" data-wow-delay="0.55s">
                            <div class="vs-blog blog-style1">
                                <div class="blog-img">
                        ...
                        <div class="col-xl-6 col-lg-12 col-md-6 wow animate__fadeInUp" data-wow-delay="0.65s">
                            <div class="vs-blog blog-style1">
                                <div class="blog-img">
                        ...
                        <div class="col-xl-6 col-lg-12 col-md-6 wow animate__fadeInUp" data-wow-delay="0.75s">
                            <div class="vs-blog blog-style1">
                                <div class="blog-img">
                        ...
                        <div class="col-xl-6 col-lg-12 col-md-6 wow animate__fadeInUp" data-wow-delay="0.85s">
                            <div class="vs-blog blog-style1">
                                <div class="blog-img">
                        ...
                        <div class="col-xl-6 col-lg-12 col-md-6 wow animate__fadeInUp" data-wow-delay="0.90s">
                            <div class="vs-blog blog-style1">
                                <div class="blog-img">
                        ...
                        <div class="col-xl-6 col-lg-12 col-md-6 wow animate__fadeInUp" data-wow-delay="0.95s">
                            <div class="vs-blog blog-style1">
                                <div class="blog-img">
