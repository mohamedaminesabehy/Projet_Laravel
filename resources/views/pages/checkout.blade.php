        ...
        <div class="container">
            ...
            <form action="#" class="woocommerce-checkout mt-40">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <p id="ship-to-different-address"><input id="ship-to-different-address-checkbox" type="checkbox" name="ship_to_different_address" value="1" checked="checked"> <label for="ship-to-different-address-checkbox">Ship to a different address? <span
            ...
            <form action="#" class="woocommerce-cart-form">
                <table class="cart_table mb-20">
                    ...
                    <tbody>
                    <tr class="cart_item">
                        <td data-title="Product"><a class="cart-productimage" href="{{ route('shop') }}"><img width="91" height="91" src="{{ asset('assets/img/product/p-thumb-1.jpg') }}" alt="Image"></a></td>
                        <td data-title="Name"><a class="cart-productname" href="{{ route('shop') }}">Present Trop Ical</a>
                        </td>
                    ...
                    <tr class="cart-subtotal">
                        ...
                        <td data-title="Subtotal" colspan="4"><span class="woocommerce-Price-amount amount"><bdi><span
                                        class="woocommerce-Price-currencySymbol">$</span>200</bdi></span></td>
                    </tr>
                ...
                <div class="woocommerce-checkout-payment">
                    <ul class="wc_payment_methods payment_methods methods">
                        ...
                        <li class="wc_payment_method payment_method_cod"><input id="payment_method_cod" type="radio" class="input-radio" name="payment_method"> <label for="payment_method_cod">Credit Cart
                                <img src="{{ asset('assets/img/others/credit-payment.png') }}" alt="image"></label>
