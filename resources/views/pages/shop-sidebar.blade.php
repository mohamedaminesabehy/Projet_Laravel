    ...
    <div class="breadcumb-wrapper" data-bg-src="{{ asset('assets/img/bg/breadcumb-bg.png') }}">
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Shop Sidebar</h1>
                ...
                <div class="col-xl-8 col-lg-7">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
                            <div class="product-style1 wow animate__fadeInUp" data-wow-delay="0.95s">
                                <div class="product-img">
                                    <img src="{{ asset('assets/img/product/product-img-5-14.jpg') }}" alt="product image">
                                    <div class="product-btns">
                                        <a href="{{ route('wishlist') }}" class="icon-btn wishlist">
                                            <i class="far fa-heart"></i>
                                        </a>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
                            <div class="product-style1 wow animate__fadeInUp" data-wow-delay="0.70s">
                                <div class="product-img">
                                    <img src="{{ asset('assets/img/product/product-img-5-15.jpg') }}" alt="product image">
                                    <div class="product-btns">
                                        <a href="{{ route('wishlist') }}" class="icon-btn wishlist">
                                            <i class="far fa-heart"></i>
                                        </a>
                ...
                <div class="col-xl-4 col-lg-5">
                    <aside class="sidebar-area">
                        ...
                        <div class="widget wow animate__fadeInUp" data-wow-delay="0.40s">
                            <h3 class="widget_title mb-35 title-shep">Filter By Price</h3>
                            <div class="slider-area">
                                <div class="slider-area-wrapper">
                                    <div id="skipstep" class="slider mb-20"></div>
                                    <div class="range-btn">
                                        <button class="vs-btn" type="submit">Filter</button>
                                        <div class="price-range">Price: $<span class="price" id="skip-value-lower"></span>-$<span class="price" id="skip-value-upper"></span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="widget product-sidebar wow animate__fadeInUp" data-wow-delay="0.60s">
                            ...
                            <div class="recent-post-wrap">
                                <div class="recent-post">
                                    ...
                                    <div class="media-body">
                                        <span class="product-author"><strong>By:</strong> Fahim Al Bashar</span>
                                        <h4 class="post-title"><a class="text-inherit" href="{{ route('blog-details') }}">Rat Phnory Mttke Srial Tofairle</a></h4>
                                        <ul class="price-list">
                                            <li><del>$39.99</del></li>
                                            <li>$30.00</li>
                                        </ul>
                                ...
                                <div class="recent-post">
                                    ...
                                    <div class="media-body">
                                        <span class="product-author"><strong>By:</strong> Fahim Al Bashar</span>
                                        <h4 class="post-title"><a class="text-inherit" href="{{ route('blog-details') }}">Amazona Book Cover</a></h4>
                                        <ul class="price-list">
                                            <li><del>$39.99</del></li>
                                            <li>$30.00</li>
                                        </ul>
                                ...
                                <div class="recent-post">
                                    ...
                                    <div class="media-body">
                                        <span class="product-author"><strong>By:</strong> Fahim Al Bashar</span>
                                        <h4 class="post-title"><a class="text-inherit" href="{{ route('blog-details') }}">Quantum Entanglement</a></h4>
                                        <ul class="price-list">
                                            <li><del>$39.99</del></li>
                                            <li>$30.00</li>
                                        </ul>
